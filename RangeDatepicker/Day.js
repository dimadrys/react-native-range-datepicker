            ...
            if (day.type == 'disabled')
                return (
                    <TouchableWithoutFeedback activeOpacity={1} style={dayStyle}>
                        <View style={{...dayStyle, height: Math.floor((DEVICE_WIDTH - dayProps.horizMargins) / 7), justifyContent: 'center'}}>
                            <Text style={{
                                ...textDayStyle,
                                textAlign: "center",
                            ...
                            {day.date == moment().format("YYYYMMDD") ? (<View style={{
                                position: 'absolute',
                                top: 0,
                                bottom: 0,
                                left: 0,
                ...
                return (
                    <TouchableWithoutFeedback activeOpacity={1} style={dayStyle}
                                              onPress={() => this.props.onSelectDate(moment(day.date, 'YYYYMMDD'))}>
                        <View style={{...dayStyle, height: Math.floor((DEVICE_WIDTH - dayProps.horizMargins) / 7), justifyContent: 'center'}}>
                            <Text style={{
                                ...textDayStyle,
                                textAlign: "center",
